...
import org.iesvdm.exercises.service.CategoriaService;
...
public class CategoriaController {
    ...
    @PostMapping({"", "/"})
    public Categoria newCategoria(@RequestBody Categoria categoria) { return this.categoriaService.save(categoria); }
    ...
    @ResponseStatus
    @DeleteMapping("/{id}")
    public void deleteCategoria(@PathVariable("id") Long id) { this.categoriaService.delete(id); }
